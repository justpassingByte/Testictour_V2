...
export default function CreateOrEditLobbyPage() {
        ...
        try {
          ...
          if (existingLobby) {
            setLobbyData({
              ...
              prizeDistribution: "standard", // This would need to be reverse-mapped from the object
            ...
            router.push("/dashboard/admin/lobbies")
          }
        } catch (error) {
          toast({
            title: "Fetch Error",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Frontend Validation (can be expanded)
  ...
  return (
    <div className="container py-8">
      <div className="flex items-center space-x-2 text-sm text-muted-foreground mb-6">
        ...
        <Link href="/dashboard/admin/lobbies">Admin Lobbies</Link>
        <ChevronRight className="h-4 w-4" />
        ...
        <form onSubmit={handleSubmit}>
          <Tabs defaultValue="basic" className="space-y-6">
            ...
            <TabsContent value="review" className="space-y-6">
              ...
              <div className="flex justify-between">
                <Link href="/dashboard/admin/lobbies">
